...
namespace Videoix.Classes
{
    ...
    public partial class Proxy11
    {
        public static Proxy11 FromJson(string json) => JsonConvert.DeserializeObject<Proxy11>(json, Videoix.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Proxy11 self) => JsonConvert.SerializeObject(self, Videoix.Converter.Settings);
    }
